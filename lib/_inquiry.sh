...
get_link_git() {
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu Equipechat que deseja instalar (ex: https://github.com/seu-projeto/projeto.git):${GRAY_LIGHT}\n\n"
  read -p "> " link_https

  printf "${WHITE} 💻 Insira o seu usuário do GITHUB:${GRAY_LIGHT}\n\n"
  read -p "> " github_user

  printf "${WHITE} 💻 Insira o seu token do GITHUB:${GRAY_LIGHT}\n\n"
  read -p "> " github_token

  # Monta o link com usuário e token
  # Remove o "https://github.com/" do início e pega só o caminho do repo
  repo_path="${link_https#https://github.com/}"
  # Remove o ".git" do final, caso queira tratar (opcional)
  repo_path="${repo_path%.git}"

  # Monta o link de clone com user e token
  link_git="https://${github_user}:${github_token}@github.com/${repo_path}.git"

  printf "${GREEN}Link de clone montado: ${link_git}${GRAY_LIGHT}\n"
}
